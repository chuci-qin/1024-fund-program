...
// =============================================================================
// Perp Trading Fee Config (Phase 2/3)
// =============================================================================

/// Discriminator for PerpTradingFeeConfig account
pub const PERP_TRADING_FEE_CONFIG_DISCRIMINATOR: u64 = 0x50455250_46454543; // "PERPFEEC"

/// Seed prefix for PerpTradingFeeConfig PDA
pub const PERP_TRADING_FEE_CONFIG_SEED: &[u8] = b"perp_trading_fee_config";

/// Seed prefix for Perp Fee Vault PDA
pub const PERP_FEE_VAULT_SEED: &[u8] = b"perp_fee_vault";
...
pub struct PerpTradingFeeConfig {
    ...
    /// Perp 手续费资金池 (Token Account，USDC)
    pub perp_fee_vault: Pubkey,
...
impl PerpTradingFeeConfig {
    ...
    /// 创建新的 PerpTradingFeeConfig
    pub fn new(
        perp_fee_vault: Pubkey,
        bump: u8,
        authorized_caller: Pubkey,
        authority: Pubkey,
        created_at: i64,
    ...
    /// PDA seeds
    pub fn seeds() -> Vec<Vec<u8>> {
        vec![PERP_TRADING_FEE_CONFIG_SEED.to_vec()]
    }
